  ...
  return (
    <section id="newsletter" className="section-container px-4 md:px-0">
      <motion.div 
        ...
        initial="hidden"
        whileInView="show"
        className="bg-red-600 rounded-2xl overflow-hidden"
      >
        <div className="relative md:px-16 px-6 py-16 md:py-24">
          {/* Background Gradient */}
          <motion.div 
            variants={fadeIn('left', 0.4)}
            className="absolute top-0 right-0 w-1/2 h-full bg-red-700 clip-path-slant hidden md:block"
          ></motion.div>
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
            ...
            >
              ...
              <motion.p 
                ...
                className="text-blue-100 text-sm sm:text-base text-center "
              >
