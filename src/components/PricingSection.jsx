...
const allServices = [
  { id: 1, name: 'تنظيف فلة', price: 1600 },
  { id: 2, name: 'تنظيف شقة', price: 650 },
  { id: 3, name: 'نقل عفش داخل بريدة', price: 225 },
  { id: 4, name: ' جلي بلاط للمتر', price: 7.5 },
  { id: 5, name: 'جلي رخام للمتر', price: 12.5 },
  { id: 6, name: 'فك وتركيب غرفة او دالوب', price: 225 },
  { id: 7, name: 'فك وتركيب ستارة', price: 40 },
  ...
  return (
    ...
    >
      ...
      <motion.div className="mb-4">
        <motion.div variants={fadeIn('up', 0.4)} className="w-full flex gap-2 flex-wrap">
